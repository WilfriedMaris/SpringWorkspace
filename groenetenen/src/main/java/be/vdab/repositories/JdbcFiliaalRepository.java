...
class JdbcFiliaalRepository implements FiliaalRepository {
	...
	//SQL statements
	private static final String BEGIN_SQL = "select id, naam, hoofdFiliaal, straat, huisNr, "
	...
	private static final String SQL_UPDATE = "update filialen set naam=:naam, hoofdFiliaal=:hoofdFiliaal, straat=:straat, huisNr=:huisNr, postcode=:postcode,"
			+ " gemeente=:gemeente, inGebruikName=:inGebruikName, waardeGebouw=:waardeGebouw where id=:id";
	//SQL statements end
